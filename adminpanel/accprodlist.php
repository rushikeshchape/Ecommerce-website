...
<head>
    ...
    <title>Accessories Product list</title>
...
<div class="header_fixed">
        <table>
            ...
            <button class="btncs"><a href="insertacc.php">Add Product</a></button>
    ...
    while($product = mysqli_fetch_array($result)) {  
       ?> <tbody>
            <tr>
                ...
                <td><a href="accproddel.php?id=<?php echo $product['id']; ?>"><button class="feedbackviewbtn">Delete</button></a> </td>
            </tr>
        </tbody>
        <tbody>
  <?php
