...
if(isset($_POST['submit'])){
  ...
  $insertquery = "insert into `women-collection`(`prodtype`, `brand`, `name`, `price`, `image1`, `image2`, `image3`, `image4`, `description`) VALUES('$prodtype', '$brand', '$name', '$price', '$image1', '$image2', '$image3', '$image4', '$description')";
